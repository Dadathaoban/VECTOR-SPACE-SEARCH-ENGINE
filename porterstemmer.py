...
No changes needed from original Indexer Part 2
"""
...
class PorterStemmer:
    ...
    def step4(self):
        ...
        if self.b[self.k - 1] == 'a':
            ...
            if self.ends("able") or self.ends("ible"):
                pass
            else:
                return
            ...
            if self.ends("ate") or self.ends("iti"):
                pass
            else:
                return
    ...
    def stem(self, p, i, j):
        """Stem the word p[i]...p[j] inclusive."""
...
def test_stemmer():
    ...
    test_words = [
        ...
        "stemming", "stemmer", "stemmed", "stems",
